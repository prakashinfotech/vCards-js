...
describe('vCard', function() {
    ...
    testCard.customPhones = [
        [{'label': 'Father', 'phone': '12345678901'}],
        [{'label': 'Mother', 'phone': '12345678902'}],
        [{'label': 'Sister', 'phone': '12345678903'}],
        [{'label': 'Friend', 'phone': '12345678904'}]
    ];
    ...
    testCard.customEmails = [
        [{'label': 'Father', 'email': 'john@father.email'}],
        [{'label': 'Mother', 'email': 'john@mother.email'}],
        [{'label': 'Sister', 'email': 'john@sister.email'}],
        [{'label': 'Friend', 'email': 'john@friend.email'}]
    ];
    testCard.url = 'http://johndoe';
    testCard.workUrl = 'http://acemecompany/johndoe';
    testCard.customUrls = [
        [{'label': 'Father', 'web': 'http://john.doe/father'}],
        [{'label': 'Mother', 'web': 'http://john.doe/mother'}],
        [{'label': 'Sister', 'web': 'http://john.doe/sister'}],
        [{'label': 'Friend', 'web': 'http://john.doe/friend'}]
    ];
